...
class InvalidJsonMockingURLProtocol: URLProtocol {
    ...
    override func startLoading() {
        if let file = Bundle(for: DummyToGetBundle.self).path(forResource: "invalidJsonResponse", ofType: "json"),
...
extension InvalidJsonMockingURLProtocol: URLSessionDelegate {
